 ...
 * [lmnmrso.yml](lmnmrso.yml)
     * Determines how your purl.obolibrary.org/obo/lmnmrso/ redirects will be handled
     ...
     * Paste in the contents of [lmnmrso.yml](lmnmrso.yml)
 ...
 * [lmnmrso.md](lmnmrso.md)
     ...
     * Paste in the contents of [lmnmrso.md](lmnmrso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
